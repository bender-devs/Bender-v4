...
export default class APIWrapper {
    ...
    static async makeRequest<ResponseType>(
        method: string,
        path: string,
        options: types.RequestOptions
    ): types.RequestResponse<ResponseType> {
        path = API_BASE + path;
    ...
    static member = {
        ...
        async deleteRole(
            ...
            return APIWrapper.makeRequest<null>(
                'DELETE',
        ...
        async setRoles(
            guild_id: types.Snowflake,
            user_id: types.Snowflake,
            role_id_array: Array<types.Snowflake>,
            reason?: string
        ) {
    ...
    static channel = {
        ...
        async setOverwrite(
            ...
            overwrite_id: types.Snowflake,
            overwrite_data: types.PermissionOverwrites,
            reason?: string
        ) {
            return APIWrapper.makeRequest<types.GuildChannel>(
                'PUT',
    ...
    static message = {
        ...
        async edit(channel_id: types.Snowflake, message_id: types.Snowflake, message_data: types.MessageData) {
            return APIWrapper.makeRequest<types.Message>(
                'PATCH',
    ...
    static reaction = {
        async create(channel_id: types.Snowflake, message_id: types.Snowflake, emoji_identifier: string) {
            return APIWrapper.makeRequest<null>(
                'PUT',
                `/channels/${channel_id}/messages/${message_id}/reactions/${emoji_identifier}/@me`,
                {
                    headers: AUTH_HEADER,
                }
            );
        ...
        async listUsers(
            ...
            fetch_data: types.ReactionFetchData
        ) {
            return APIWrapper.makeRequest<types.User[]>(
                'GET',
                `/channels/${channel_id}/messages/${message_id}/reactions/${emoji_identifier}`,
                {
                    query: fetch_data,
                    headers: AUTH_HEADER,
                }
        ...
        async delete(
            ...
            message_id: types.Snowflake,
            emoji_identifier: string,
            user_id: types.SnowflakeOrMe,
            reason?: string
        ) {
            return APIWrapper.makeRequest<null>(
                'DELETE',
                `/channels/${channel_id}/messages/${message_id}/reactions/${emoji_identifier}/${user_id}`,
                {
                    headers: APIWrapper.addReasonHeader(AUTH_HEADER, reason),
                }
            );
    ...
    static globalCommand = {
        ...
        async fetch(application_id: types.Snowflake, command_id: types.Snowflake) {
            return APIWrapper.makeRequest<types.Command>(
                'GET',
    ...
    static guildCommand = {
        ...
        async create(
            application_id: types.Snowflake,
            guild_id: types.Snowflake,
            command_data: types.CommandCreateData
        ) {
            return APIWrapper.makeRequest<types.Command>(
                'POST',
                `/applications/${application_id}/guilds/${guild_id}/commands`,
        ...
        async replaceAll(
            application_id: types.Snowflake,
            guild_id: types.Snowflake,
            commands_data: types.CommandCreateData[]
        ) {
            return APIWrapper.makeRequest<types.Command[]>(
                'PUT',
                `/applications/${application_id}/guilds/${guild_id}/commands`,
    ...
    static guildCommandPermissions = {
        async list(application_id: types.Snowflake, guild_id: types.Snowflake) {
            return APIWrapper.makeRequest<types.CommandPermissions[]>(
                'GET',
        ...
        async edit(
            ...
            guild_id: types.Snowflake,
            command_id: types.Snowflake,
            permissions_data: types.CommandPermissionsData
        ) {
            return APIWrapper.makeRequest<types.Command>(
                'PUT',
                `/applications/${application_id}/guilds/${guild_id}/commands/${command_id}/permissions`,
    ...
    static interactionResponse = {
        async create(
            interaction_id: types.Snowflake,
            interaction_token: string,
            interaction_response: types.InteractionResponse
        ) {
            return APIWrapper.makeRequest<types.Message>(
                'POST',
    ...
    static autoModRule = {
        async list(guild_id: types.Snowflake) {
            return APIWrapper.makeRequest<types.AutoModRule[]>(
                'GET',
