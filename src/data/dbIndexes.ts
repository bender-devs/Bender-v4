...
type CollectionName =
    ...
    | 'oauth_keys'
    | 'commands'
    | 'guild_commands'; // don't export, as this is missing bot_settings
...
const DB_INDEXES: Indexes = {
    ...
    guild_commands: [{ name: 'guild_id', options: { unique: true } }],
    premium: [
    ...
    bot_status: [{ name: 'shard_id', options: { unique: true } }],
    oauth_keys: [
